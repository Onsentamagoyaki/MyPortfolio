...
public class MiniCannonMove : MonoBehaviour,EnemyAttack
{
    ...
    {
        _power = _enemyDatas._EnemyDatas[4]._power;
        GetComponent<EnemyHP>()._SetHP(_enemyDatas._EnemyDatas[4]._hp);
        _rotSpeed = _enemyDatas._EnemyDatas[4]._otherPara1;
    }
